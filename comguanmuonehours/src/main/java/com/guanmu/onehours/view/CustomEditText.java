    ...
    public void onSelectionChanged(int selStart, int selEnd) {
        ...
        if (selStart > 0 && selStart == selEnd) {
            ...
            for (CharacterStyle styleSpan : styleSpans) {
                ...
                } else if (styleSpan instanceof AgsUnderlineSpan) {
    ...
    private class DWTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable editable) {
            ...
            if (position > 0) {
                ...
                for (CharacterStyle appliedStyle : appliedStyles) {
                    ...
                    } else if (appliedStyle instanceof AgsUnderlineSpan) {
                        // Underlined style found
                        currentAgsUnderlineSpan = (AgsUnderlineSpan) appliedStyle;
        ...
        private void handleInsertItalicCharacter(Editable editable, int position,
            ...
            if (italicsToggle != null && italicsToggle.isChecked() && currentItalicSpan == null) {
                editable.setSpan(new StyleSpan(Typeface.ITALIC), position - appendTextLength,
                        position,
                        Spannable.SPAN_INCLUSIVE_INCLUSIVE);
                ...
                if (italicEnd > position) {
                    editable.setSpan(new StyleSpan(Typeface.ITALIC), position,
                            italicEnd,
                            Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                }
            }
